const _principalAmount = document.getElementById("principle");
const _interestRateYear = document.getElementById("interest");
const _tenureMonth = document.getElementById("months");
